...
void test() {
  ...
  printf("List bucket cloudfs:\n");
  cloud_list_bucket("cloudfs", list_bucket);
  printf("\n\n\n");
  ...
  // cloud_delete_object("cloudfs", "+mnt+ssd+test.c");
  // cloud_print_error();
  ...
  // printf("Delete bucket cloudfs:\n");
  // cloud_delete_bucket("cloudfs");
  // cloud_print_error();
